...
from src.components.model_training import DataTrainingConfig
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df=pd.read_csv(r"D:\Fraud detection\src\components\data\data1.csv")
            print(df.head())
            logging.info("exported the data")
